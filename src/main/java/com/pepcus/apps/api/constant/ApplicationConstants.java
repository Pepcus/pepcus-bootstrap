package com.pepcus.apps.api.constant;
...
public class ApplicationConstants {
    ...
    public static final String SUPPRESS_EMAIL_PARAM = "suppressEmail";
    ...
    public static final String SIGN_DOCUMENT_RESOURCE = "sign-documents";
    public static final String SIGN_DOCUMENT_USER_RESOURCE = "sign-documents.users";
    public static final String SIGNATURE_RESOURCE = "signatures";
    ...
    public static final String ESIGNATURE_SKU_KEY = "esignature";
