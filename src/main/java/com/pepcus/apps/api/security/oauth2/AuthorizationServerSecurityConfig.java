...
import com.pepcus.apps.api.services.AppClientDetailsService;
import com.pepcus.apps.api.services.THRUserDetailsService;
...
public class AuthorizationServerSecurityConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
	private THRUserDetailsService thrUserDetailsService;
