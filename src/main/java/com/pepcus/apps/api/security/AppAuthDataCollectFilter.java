...
import static com.pepcus.apps.api.constant.ApplicationConstants.API_ACCESS_TOKEN;
import static com.pepcus.apps.api.constant.ApplicationConstants.APP_AUTH_DATA;
import static com.pepcus.apps.api.constant.ApplicationConstants.BROKER_ID_PARAM;
import static com.pepcus.apps.api.constant.ApplicationConstants.COMPANY_ID_PARAM;
import static com.pepcus.apps.api.constant.ApplicationConstants.ROLE_PARAM;
        ...
        try {
            ...
            if (tokenObj != null) {
                ...
                if (StringUtils.isNotBlank(token)) {
                    ...
                    request.setAttribute(COMPANY_ID_PARAM, appAuthData.getClientId());
