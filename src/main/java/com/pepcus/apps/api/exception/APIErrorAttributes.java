...
import static com.pepcus.apps.api.constant.ApplicationConstants.API_ERROR_CODE;
import static com.pepcus.apps.api.constant.ApplicationConstants.API_EXCEPTION_DETAIL;
import static com.pepcus.apps.api.constant.ApplicationConstants.API_VERSION;
import static com.pepcus.apps.api.constant.ApplicationConstants.CODE;
import static com.pepcus.apps.api.constant.ApplicationConstants.ERROR_STATUS_CODE;
import static com.pepcus.apps.api.constant.ApplicationConstants.MESSAGE;
import static com.pepcus.apps.api.constant.ApplicationConstants.STATUS;
import static com.pepcus.apps.api.constant.ApplicationConstants.TIMESTAMP;
...
/**
 * Wrapper class used to wrap the exceptions 
 * related with internal server error and
 * unauthorized error.
 */
@Component
