...
import static com.pepcus.apps.api.constant.ApplicationConstants.CLOSE_OPEN_BRACKET;
import static com.pepcus.apps.api.constant.ApplicationConstants.REGEX_FOR_PROJECTION_FIELDS;
import static com.pepcus.apps.api.constant.ApplicationConstants.SMALL_OPEN_BRACKET;
import static com.pepcus.apps.api.constant.ApplicationConstants.TOTAL_RECORDS;
import static com.pepcus.apps.api.exception.APIErrorCodes.INVALID_FIELD_EXPRESSION;
import static com.pepcus.apps.api.exception.APIErrorCodes.INVALID_FIELD_NAME;
import static com.pepcus.apps.api.utils.EntitySearchUtil.classHasField;
...
import com.pepcus.apps.api.repositories.BaseRepository;
...
public class CommonService {
    ...
    @Value("${com.pepcus.apps.api.threadpool.size}")
    ...
    Map<String, Class> nestedClasses;
    ...
    /**
     * Validates given object for any constraint violations and throws ConstraintViolationException if any 
     ...
     * @return
     */
    protected <T> List<T> findAll(boolean isBroker, Pageable pageable, Specification<T> spec, Class klass, BaseRepository repository, String attributeName,
     ...
     * @return
     */
    protected List<Integer> findAllIds(Pageable pageable, Specification spec, BaseRepository repository, String attributeName) {
    ...
    /**
     * To parse field expression to support projections
    ...
    /**
     * Generic method to support projection with given fields. Supports nested objects.
     * TODO: To add support for second level nesting.
     * @param object
     * @param kclass
     * @param classVsFieldMap 
     * @return
     ...
     * @return
     */
    protected <T> T findOne(Integer id, Class klass, BaseRepository repository, Map<String, List<String>> classVsFieldMap) {
