...
/**
 * This class is a single global exception handler component wrapping for all the exceptions from
 * APIs, prepare a Response object with required exception details sending back to users.
 * 
...
public class APIExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
    ...
    apiError.setMessage(
        getMessageFromResourceBundle(resourceHandler, APIErrorCodes.REQUIRED_PARAMETER, ex.getParameterName()));
  ...
  protected ResponseEntity<Object> handleMissingServletRequestPart(MissingServletRequestPartException ex,
    ...
    APIError apiError = new APIError(BAD_REQUEST, ex);
    apiError.setMessage(
        getMessageFromResourceBundle(resourceHandler, APIErrorCodes.REQUIRED_PARAMETER, ex.getRequestPartName()));
    return buildResponseEntity(apiError);
  }
  ...
  /**
   * Handles org.springframework.web.method.annotation.MethodArgumentTypeMismatchException,
   * PropertyReferenceException and IllegalArgumentException. Throws when @Validated fails
   * 
   * @param ex
   * @return
   */
  @ExceptionHandler({org.springframework.web.method.annotation.MethodArgumentTypeMismatchException.class,
      org.springframework.data.mapping.PropertyReferenceException.class, java.lang.IllegalArgumentException.class})
  ...
  protected ResponseEntity<Object> handleAPIBadRequest(ApplicationException ex) {
    ...
    apiError.setMessage(
        getMessageFromResourceBundle(resourceHandler, ex.getApiErrorCode(), ex.getErrorMessageParameters()));
    return buildResponseEntity(apiError);
  }
