...
/**
 * Class to evaluate permission to access API/Resource
 * 
...
public class PermissionEvalUtil {
  ...
  public static String getRequiredSelfPermissionOnResourceAndAccess(String resource, String permission) {
    return PERMISSION_PREFIX + DOT + resource + DOT + permission + DOT + SELF_ACCESS_PERMISSION;
  }
  ...
  public static Integer getFromRequestParam(String paramName) {
    Map<String, String[]> requestParamMap = (Map<String, String[]>) RequestUtil.getRequestAttribute(REQUEST_PARAMETERS);
    ...
    try {
      ...
      throw ApplicationException.createBadRequest(APIErrorCodes.VALUE_NOT_INT, paramName);
    }
  }
