...
/**
 * To keep some common utility methods
 * 
...
public class CommonUtil {
  ...
  /**
   * This will return current date in UTC TODO: Need to implement so that returned date instance is
   * for UTC time
   * 
   * @return
   */
  ...
  /**
   * This function returns the first object which is instance of class cls from array of objects
   * objs. If no objects from objs is instance of cls then returns null.
   * 
   * @param cls
   * @param objs
   * @return
  ...
  public static void main(String args[]) {
    System.out.println(generateRandomAlphanumericHexString(8));
    System.out.println(generateRandomAlphanumericHexString(32));
