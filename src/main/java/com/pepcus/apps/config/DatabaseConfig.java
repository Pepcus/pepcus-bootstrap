...
/**
 * Database configuration file to manage data-source
 * 
...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager",
    basePackages = {"com.pepcus.apps.db.repositories"}, repositoryBaseClass = BaseRepositoryImpl.class)
public class DatabaseConfig {

  /**
   * Build data-source for basePackages
   * 
   * @return
   */
  @Primary
  ...
  /**
   * Build entity manager factory for basePackages
   * 
   * @param builder
   * @param dataSource
   * @return
  ...
  /**
   * Build transaction manager for basePackages
   * 
  ...
  /**
   * Build jdbc template for basePackages
   * 
   * @param dataSource
   * @return
   */
